...
INSERT INTO `kitap_tablosu` VALUES ('3165','Huzursuzluk','Doğan Kitap',3),('3598','İnsan ve Davranışı','Remzi Kitabevi',3),('4136','Olasılıksız','April Yayınları',2),('4781','Da Vinci Şifresi','Altın Kitaplar',1),('5896','Ve Perde İndi','Altın Kitaplar',3),('5987','Mutluluk Varsayımı','Hil Yayınları',2),('7231','Hayvan Çiftliği','Can Yayınları',1),('8102','İnsan Olmak','Remzi Kitapevi',1),('9637','İçimizdeki Şeytan','Yapı Kredi Yayınları',2);
